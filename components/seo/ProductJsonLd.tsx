...
const products = {
  ...
  'corporate-ai': {
    ...
    faq: [
      ...
      {
        q: 'Сколько стоит Corporate AI (RAG)?',
        a: 'Стоимость запуска от $8 000, ежемесячное обслуживание от $3 000. Точная цена определяется после бесплатного аудита в зависимости от объёма документов и интеграций.',
      },
    ],
  },
};

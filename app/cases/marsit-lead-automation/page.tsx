...
export const metadata: Metadata = {
  ...
  keywords: ['кейс marsit ai', 'автоматизация продаж ташкент', 'квалификация лидов ai'],
...
const caseStudySchema = {
  ...
  '@type': 'Article',
  headline: 'Кейс Marsit: AI-автоматизация лидов и продаж',
  description: DESCRIPTION,
    ...
    <main className="min-h-screen bg-[#05050A] text-white pt-28 pb-16">
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-6">
        <nav className="flex items-center gap-1.5 text-sm text-[#64748B] mb-8">
          ...
          <ChevronRight className="w-3.5 h-3.5" />
          <span className="text-[#F8FAFC]">Кейс Marsit</span>
        </nav>
        ...
        <div className="rounded-2xl p-8 md:p-10 border border-white/10 bg-white/[0.02]">
          ...
          <h1 className="text-3xl md:text-5xl font-bold tracking-tight leading-tight">
            Marsit.uz: AI-автоматизация лидов для отдела продаж
          </h1>
          <p className="mt-4 text-[#94A3B8] max-w-3xl text-base md:text-lg">
            Запустили AI-квалификацию обращений, маршрутизацию горячих лидов и сценарии ответов по
            возражениям. Фокус — не терять заявки в нерабочее время и повышать конверсию в звонок.
          </p>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-6 mt-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <article className="rounded-xl border border-white/10 bg-white/[0.02] p-5">
            ...
            <p className="mt-2 text-[#CBD5E1]">Стабильный прием лидов 24/7 и рост конверсии в целевой звонок.</p>
          </article>
          <article className="rounded-xl border border-white/10 bg-white/[0.02] p-5">
            <p className="text-sm text-[#93C5FD]">Решение</p>
            <p className="mt-2 text-[#CBD5E1]">AI-бот с Cold/Warm/Hot классификацией и передачей hot-лидов менеджерам.</p>
          </article>
          <article className="rounded-xl border border-white/10 bg-white/[0.02] p-5">
      ...
      <section className="max-w-5xl mx-auto px-4 md:px-6 mt-12">
        <div className="rounded-2xl p-7 border border-[#3B82F6]/30 bg-[#3B82F6]/10">
          ...
          <p className="mt-3 text-[#CFE2FF] max-w-3xl">
            Подготовим для вас маршрут внедрения AI и запустим пилот с измеримыми KPI.
          </p>
          <Link

    ...
    <>
      <BreadcrumbJsonLd
        items={[
          { name: 'Главная', url: '/' },
          { name: 'Блог', url: '/blog/' },
          { name: TITLE, url: `/blog/ii-avtomatizaciya-biznesa-uzbekistan/` },
        ]}
      />
      <script
        ...
        <div className="pt-28 pb-10 bg-background-secondary border-b border-border">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <nav className="flex items-center gap-2 text-sm text-[#64748B] mb-6">
              ...
              <span>/</span>
              <span className="text-foreground">ИИ автоматизация бизнеса</span>
            </nav>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-12">
          <article className="space-y-8 text-[#94A3B8] leading-relaxed text-base md:text-lg">
            ...
            <section className="space-y-4">
              ...
              <p>
                <strong className="text-foreground">Обработка входящих обращений.</strong> Самая
              ...
              <p>
                <strong className="text-foreground">Бизнес-аналитика и отчётность.</strong> Вместо
              ...
              <p>
                <strong className="text-foreground">Корпоративная база знаний.</strong> HR-политики,
              ...
              <p>
                <strong className="text-foreground">Управление задачами и контроль команды.</strong>
            ...
            <section className="space-y-4">
              ...
              <p>
                <strong className="text-foreground">Базовая автоматизация</strong> — чат-бот для
              ...
              <p>
                <strong className="text-foreground">Полная автоматизация продаж</strong> — три канала
              ...
              <p>
                <strong className="text-foreground">Корпоративная ИИ-платформа</strong> — полная
          ...
          <section className="mt-16 pt-12" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <h2 className="text-2xl font-bold text-foreground mb-3">Решения AI Solution</h2>

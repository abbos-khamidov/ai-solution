        ...
        <div className="pt-28 pb-10" style={{ background: '#0D0D1A', borderBottom: '1px solid rgba(255,255,255,0.06)' }}>
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <nav className="flex items-center gap-2 text-sm text-[#64748B] mb-6">
              ...
              <span>/</span>
              <span className="text-[#F8FAFC]">Аналитика для компаний</span>
            </nav>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-12">
          <article className="space-y-8 text-[#94A3B8] leading-relaxed text-base md:text-lg">
            ...
            <section className="space-y-4">
              ...
              <p>
                <strong className="text-[#F8FAFC]">Аналитика продаж.</strong> Воронка продаж
              ...
              <p>
                <strong className="text-[#F8FAFC]">Финансовая аналитика.</strong> Дашборд
              ...
              <p>
                <strong className="text-[#F8FAFC]">Аналитика клиентского сервиса.</strong>
              ...
              <p>
                <strong className="text-[#F8FAFC]">Аналитика операционной эффективности.</strong>
            ...
            <section className="space-y-4">
              ...
              <p>
                <strong className="text-[#F8FAFC]">Telegram-дашборд.</strong> Самое быстрое
              ...
              <p>
                <strong className="text-[#F8FAFC]">Веб-дашборд.</strong> Интерактивный
              ...
              <p>
                <strong className="text-[#F8FAFC]">Power BI / Tableau интеграция.</strong>
          ...
          <section className="mt-16 pt-12" style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            <h2 className="text-2xl font-bold text-[#F8FAFC] mb-3">Аналитика и автоматизация от AI Solution</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <Link href="/services/analytics" className="group block p-6 rounded-2xl transition-all duration-300 hover:-translate-y-1" style={{ background: 'rgba(6,182,212,0.06)', border: '1px solid rgba(6,182,212,0.2)' }}>
                ...
                <h3 className="font-bold text-[#F8FAFC] mb-2">Аналитика и дашборды</h3>

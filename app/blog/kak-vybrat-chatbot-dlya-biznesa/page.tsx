    ...
    <>
      <BreadcrumbJsonLd
        items={[
          { name: 'Главная', url: '/' },
          { name: 'Блог', url: '/blog/' },
          { name: TITLE, url: `/blog/kak-vybrat-chatbot-dlya-biznesa/` },
        ]}
      />
        ...
        <div className="pt-28 pb-10 bg-background-secondary border-b border-border">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <nav className="flex items-center gap-2 text-sm text-[#64748B] mb-6">
              ...
              <span>/</span>
              <span className="text-foreground">Как выбрать чатбот</span>
            </nav>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-12">
          <article className="space-y-8 text-[#94A3B8] leading-relaxed text-base md:text-lg">
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Сценарий или ИИ: что выбрать</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Каналы: один или несколько</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Квалификация лидов и передача менеджеру</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Интеграции и данные</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Бюджет и сроки</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-2xl md:text-3xl font-bold text-foreground">Чеклист перед запуском</h2>

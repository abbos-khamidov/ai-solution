    ...
    <>
      <BreadcrumbJsonLd
        items={[
          { name: 'Главная', url: '/' },
          { name: 'Блог', url: '/blog/' },
          { name: TITLE, url: `/blog/ai-chatbot-dlya-biznesa-uzbekistan/` },
        ]}
      />
      <script
        ...
        <div className="pt-28 pb-10 bg-background-secondary border-b border-border">
          <div className="max-w-4xl mx-auto px-4 md:px-6">
            <nav className="flex items-center gap-2 text-sm text-[#64748B] mb-6">
              ...
              <span>/</span>
              <span className="text-foreground">AI чат-бот для бизнеса</span>
            </nav>
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 py-12">
          <article className="space-y-8 text-[#94A3B8] leading-relaxed text-base md:text-lg">
            ...
            <section className="space-y-4">
              ...
              <p>
                <strong className="text-foreground">Cold</strong> — первый контакт, человек
              ...
              <p>
                <strong className="text-foreground">Warm</strong> — клиент активно интересуется,
                задаёт конкретные вопросы, сравнивает варианты. AI собирает все детали и готовит
                почву для закрытия сделки.
              </p>
              <p>
                <strong className="text-foreground">Hot</strong> — клиент готов купить. В этот

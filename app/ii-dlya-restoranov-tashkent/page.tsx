    ...
    <>
      ...
      <main className="min-h-screen bg-[#05050A] text-white pt-28 pb-16">
        ...
        <section className="max-w-6xl mx-auto px-4 md:px-6 mt-12">
          <h2 className="text-2xl md:text-3xl font-bold text-[#F8FAFC] mb-4">Как ИИ решает задачи ресторанов и кафе</h2>
        ...
        <section className="max-w-6xl mx-auto px-4 md:px-6 mt-12">
          <h2 className="text-2xl md:text-3xl font-bold text-[#F8FAFC] mb-4">Что получает ресторан после внедрения</h2>

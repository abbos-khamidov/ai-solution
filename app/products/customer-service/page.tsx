  ...
  const csPricingPlans: PricingPlan[] = useMemo(() => [
    {
      ...
      description: 'Быстрый тест AI-бота для продаж',
      problem: 'Лиды пишут ночью — никто не отвечает',
      result: 'AI отвечает 24/7 и передаёт горячих менеджеру',
      roi: {
    ...
    },
    {
      ...
      description: 'Полная автоматизация клиентского сервиса',
      problem: 'Менеджеры не успевают, заявки теряются в потоке',
      result: 'Рост заявок на 30–70%, воронка под контролем',
      roi: {
        label: 'Увеличивает конверсию в заявку на 30–70%',
        detail: 'Средний чек $4 200 · окупается за 2–4 месяца',
      },
      highlighted: true,
      features: [
    ...
    },
    {
      ...
      description: 'Масштабный клиентский сервис для крупного бизнеса',
      problem: 'Десятки каналов, тысячи обращений, нет единой системы',
      result: 'Единый AI-хаб для всех каналов, полная аналитика',
      roi: {
        label: 'Экономит 2–5 зарплат операторов',
        detail: 'Неограниченные диалоги, кастомная логика',
      },
      highlighted: false,
      features: [
        'Все каналы + API',
